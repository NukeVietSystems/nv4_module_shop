			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<div class="row">
						...
						<div class="form-group">
							<label class="col-md-4 control-label">{LANG.content_mcat}</label>
							<div class="col-md-20">
								<select class="form-control" name="mcatid" id="mcatid" onchange="nv_change_mcatid(this, {rowcontent.id})" style="width: 100%">
									<option value="0" data-label="1"> ---{LANG.content_cat_c}--- </option>
									<!-- BEGIN: rowsmcat -->
									<option value="{ROWSMCAT.catid}" {ROWSMCAT.selected} data-label="{ROWSMCAT.typeprice}">{ROWSMCAT.title}</option>
									<!-- END: rowsmcat -->
								</select>
							</div>
						</div>
