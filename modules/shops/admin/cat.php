...
$table_name = TABLE_SHOP_MAIN . '_catalogs';
$error = $admins = '';
$savecat = 0;
...
if (!empty($savecat)) {
    ...
    if ($data['catid'] == 0 and $data['title'] != '' and $error == '') {
        ...
        $sql = "INSERT INTO " . $table_name . " (catid, parentid, image, weight, sort, lev, viewcat, numsubcat, subcatid, inhome, numlinks, newday, typeprice, form, group_price, viewdescriptionhtml, admins, add_time, edit_time, groups_view, cat_allow_point, cat_number_point, cat_number_product, idsite " . $listfield . " )
 			VALUES (NULL, :parentid, :image," . $weight . ", '0', '0', :viewcat, '0', :subcatid, '1', '4', :newday, :typeprice, :form, :group_price, :viewdescriptionhtml, :admins, " . NV_CURRENTTIME . ", " . NV_CURRENTTIME . ", :groups_view, :cat_allow_point, :cat_number_point, :cat_number_product, :idsite" . $listvalue . ")";
        $data_insert = array();
