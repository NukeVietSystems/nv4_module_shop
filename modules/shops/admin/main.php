...
$number = $db->query('SELECT COUNT(*) FROM ' . TABLE_SHOP_MAIN . '_rows WHERE publtime < ' . NV_CURRENTTIME . ' AND (exptime=0 OR exptime>' . NV_CURRENTTIME . ')')->fetchColumn();
$array_info[] = array(
...
$number = $db->query('SELECT SUM(product_number) FROM ' . TABLE_SHOP_MAIN . '_rows')->fetchColumn();
$array_info[] = array(
...
$number = $db->query('SELECT COUNT(*) FROM ' . TABLE_SHOP_MAIN . '_orders WHERE order_view = 0')->fetchColumn();
$array_info[] = array(
...
$number = $db->query('SELECT COUNT(*) FROM ' . TABLE_SHOP_MAIN . '_orders WHERE transaction_status = -1')->fetchColumn();
$array_info[] = array(
...
$number = $db->query('SELECT COUNT(*) FROM ' . TABLE_SHOP_MAIN . '_orders WHERE transaction_status = 0')->fetchColumn();
$array_info[] = array(
...
$number = $db->query('SELECT COUNT(*) FROM ' . TABLE_SHOP_MAIN . '_orders WHERE transaction_status = 4')->fetchColumn();
$array_info[] = array(
...
// Tong so luong don dat hang da gui thanh toan
$number = $db->query('SELECT COUNT(*) FROM ' . TABLE_SHOP_MAIN . '_orders WHERE transaction_status = 5')->fetchColumn();
$array_info[] = array(
